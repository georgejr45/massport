...
```{sh}
# Extras to use in command line(optional)
...
# command to fetch the zip files and finding out the zipped secrets
find /home/mgeorge/testproject/chemotion_data -type f -name "*.zip" | while read zipfile; do
    unzip -oq -d /home/mgeorge/testproject/unzipped/${zipfile%.zip} "$zipfile" 
done
...
```{sh}
# Convert to mzml,  download the converter.sh script and perform
bash converter.sh  /home/mgeorge/testproject/files_4_MS_converter/  /home/mgeorge/testproject/converted_data
